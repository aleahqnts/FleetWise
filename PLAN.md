...
| 16 | View Vehicle Details Modal | Vehicles | Block 14 | 🏗️ UI built first (static BUS-02 example) — per-vehicle fetch pending |
| 17 | Edit Vehicle Modal (incl. maintenance-log update) | Vehicles | Block 14 | 🏗️ UI built first (static BUS-02 example) — fetch + POST + `verified_by` column pending |
